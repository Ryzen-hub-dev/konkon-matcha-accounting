...
- Owner-only Telegram Bot API, Feishu/Lark custom bot and Discord webhook connections. Official hosts are allow-listed, credentials/signing secrets are encrypted, connection tests send a visible message, Discord mentions are disabled and workspace mode changes can broadcast without exposing secrets.
