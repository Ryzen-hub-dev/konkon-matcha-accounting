...
const rolePermissions: Record<UserRole, ReadonlySet<Permission>> = {
  ...
  MANAGER: new Set([
    ...
    "inventory.write", "invoices.read", "invoices.write", "reports.read", "budgets.read", "team.read",
  ...
  ACCOUNTANT: new Set([
    ...
    "accounting.write", "budgets.read", "budgets.write", "invoices.read", "invoices.write", "reports.read", "receipts.read", "payments.read",
...
export const ACCESS_AREAS: ReadonlyArray<{ label: string; read: Permission; manage?: Permission; useLabel?: string }> = [
  ...
  { label: "Budgets & variance", read: "budgets.read", manage: "budgets.write" },
  { label: "Cost centres & projects", read: "reports.read", manage: "accounting.write" },
  { label: "Invoices", read: "invoices.read", manage: "invoices.write" },
  { label: "Reports", read: "reports.read" },
  { label: "Exception reviews", read: "reviews.read", manage: "reviews.manage" },
