...
import { AlertTriangle, BookCheck, CalendarRange, CheckCircle2, Landmark, LockKeyhole, RotateCcw, ShieldCheck } from "lucide-react";
...
type Checklist = {
  ...
  openBankReconciliationCount: number; blockers: string[]; ready: boolean;
};
type Period = {
