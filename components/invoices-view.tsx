...
import { dateKeyInTimeZone, shiftDateKey, formatCalendarDate } from "@/lib/dates";
...
export function InvoicesView() {
  ...
  const dueDateFrom = (days: number) => shiftDateKey(dateKeyInTimeZone(new Date(), profile.timeZone), days);
